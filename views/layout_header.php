...
<div id="mobile-drawer" class="fixed inset-y-0 left-0 w-72 bg-slate-900 text-white z-[60] transform -translate-x-full shadow-2xl md:hidden font-black text-[10px] uppercase">
...
<div class="flex">
    <aside class="hidden md:flex flex-col w-64 bg-slate-900 text-slate-300 min-h-screen sticky top-0 shadow-2xl flex-shrink-0">
        ...
        <nav class="flex-1 px-4 space-y-1 pt-6 overflow-y-auto no-scrollbar">
            ...
            <p class="px-4 py-2 text-[10px] font-black text-slate-500 uppercase tracking-widest mt-6 pt-6 border-t border-slate-800">RRHH Benigànim</p>
