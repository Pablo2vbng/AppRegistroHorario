...
<div class="max-w-4xl mx-auto pb-20">
    <div class="no-print bg-slate-900 text-white p-6 rounded-[35px] mb-8 shadow-xl flex justify-between items-center mx-2">
        ...
        <button onclick="window.print()" class="bg-blue-600 px-5 py-2 rounded-xl font-black text-[10px] uppercase">PDF</button>
    </div>
    ...
    <!-- DOCUMENTO -->
    <div class="bg-white p-6 md:p-12 border border-slate-200 print:border-none print:p-0 mx-2">
        <div class="flex justify-between items-start border-b-4 border-slate-900 pb-6 mb-8">
            <div>
                ...
                <p class="text-[9px] font-black text-slate-400 uppercase">Benigànim • RD-Ley 8/2019</p>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10 text-[10px] uppercase font-bold">
            ...
            <div class="md:text-right p-5">
                ...
                <p class="text-blue-600 mt-1 italic"><?php echo date('F Y', mktime(0,0,0,$mes,1,$anio)); ?></p>
            </div>
        </div>
            ...
            <table class="w-full text-left border-collapse min-w-[500px]">
                ...
                <tbody class="text-[10px] font-bold">
                    ...
                    for($d=1; $d<=$diasEnMes; $d++):
                        ...
                        if(isset($datos[$fecha])) {
                            ...
                            if($last['tipo'] == 'salida') {
                                ...
                                $totalS += $sec; $h_t = floor($sec/3600).":".str_pad(floor(($sec/60)%60), 2, '0', STR_PAD_LEFT);
                            }
                        }
                    ?>
                    <tr class="<?php echo isset($datos[$fecha])?'bg-white':'bg-slate-50 text-slate-300'; ?>">
                        ...
                        <td class="p-1.5 border border-slate-200 text-center"><?php echo $gps; ?></td>
                ...
                <tfoot>
                    <tr class="bg-slate-100 font-black text-xs">
                        <td colspan="4" class="p-3 border border-slate-900 text-right uppercase">Total Mes</td>
                        <td class="p-3 border border-slate-900 text-right"><?php echo floor($totalS/3600); ?>h <?php echo floor(($totalS/60)%60); ?>m</td>
                    </tr>
                </tfoot>
            </table>
        </div>
