...
// 1. Obtener Festivos y Cierres actualizados
...
<div class="max-w-7xl mx-auto pb-20">
    <div class="flex flex-col md:flex-row justify-between items-center mb-12 gap-6">
        <div class="text-center md:text-left">
            ...
            <p class="text-slate-400 font-bold text-sm mt-2 italic">Festivos Benigànim y Cierres de Empresa</p>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        ?>
        <div class="bg-white rounded-[40px] shadow-sm border border-slate-100 p-6 hover:shadow-2xl transition-all duration-500 relative overflow-hidden">
    ...
    <div class="mt-16 flex flex-wrap justify-center gap-8 text-[9px] font-black uppercase tracking-[0.2em] text-slate-400 bg-white p-10 rounded-[45px] border border-slate-100 shadow-sm">
        <div class="flex items-center"><span class="w-4 h-4 bg-blue-600 rounded-lg mr-2"></span> Festivo Nacional / Comunidad</div>
        <div class="flex items-center"><span class="w-4 h-4 bg-amber-400 rounded-lg mr-2"></span> Local Benigànim</div>
        <div class="flex items-center"><span class="w-4 h-4 bg-rose-500 rounded-lg mr-2"></span> Cierre CVTools (Resta Vac.)</div>
        <div class="flex items-center"><span class="w-4 h-4 bg-emerald-500 rounded-lg mr-2"></span> Vacaciones Libres</div>
    </div>
</div>